...
namespace WebApiService.Controllers
{
    public class EnrollCourseController : Controller
    {
        ...
        public JsonResult GetCourses(int courecode)
        {
        ...
        public ActionResult Create([Bind(Include = "Id,RegistrationNo,CourseId,EnrollDate,CourseMark")] EnrollCourse enrollcourse)
        {
        ...
        public ActionResult SaveResult()
        {
            ...
            ViewBag.StudentList = db.Students.ToList();
            ViewBag.MarkList = db.Marks.ToList();
            return View();
        }
        ...
        public ActionResult Edit([Bind(Include = "Id,RegistrationNo,CourseId,EnrollDate,CourseMark")] EnrollCourse enrollcourse)
        {
            if (ModelState.IsValid)
            {
